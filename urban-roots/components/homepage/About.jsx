...
const About = () => {
  return (
    <section className="py-16 px-6 lg:px-8 text-black">
        <div className="container mx-auto max-w-4xl">
            ...
            <div className="flex flex-col-reverse lg:flex-row items-center">
                <div className="lg:w-1/2 lg:pr-8 mb-8 lg:mb-0">
                    ...
                    <ul className="list-disc list-inside mb-4 w-fit">
                ...
                <div className="lg:w-1/2">
                    <img src="/media/community-gardening.jpeg" alt="Jardinage communautaire en zone urbaine" className="h-full rounded-lg shadow-lg mb-5" />
                </div>
            </div>
        </div>
    </section>
