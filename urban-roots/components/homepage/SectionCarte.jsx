...
const SectionCarte = () => {
  return (
    <section className="py-16 px-6 lg:px-8 bg-gray-100 text-black">
        <div className="container mx-auto max-w-4xl">
            ...
            <div className="flex flex-col lg:flex-row items-center">
                <div className="lg:w-1/2 lg:pr-8 mb-8 lg:mb-0">
                    <img src="/media/map-thumbnail.png" alt="Interactive map showing urban gardening spots" className="w-full rounded-lg shadow-lg" />
                </div>
