...
const SectionRessources = () => {
  return (
    <section className="py-16 px-7 lg:px-8 bg-white text-gray-800">
        <div className="container mx-auto max-w-4xl">
            ...
            <div className="flex flex-col-reverse lg:flex-row items-center">
                ...
                <div className="lg:w-1/2">
                    <img src="/media/gardening-tools.jpeg" alt="Gardening tools representing resources and advice" className="w-full rounded-lg shadow-lg object-cover h-[400px] lg:h-auto mb-5" />
                </div>
            </div>
        </div>
        </section>
